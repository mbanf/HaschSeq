...
if(b.save_intermediate_results){
  write.table(l.selection[[1]], paste(folder_output, "/bQTL_after_input_blacklisting_pvalue_filter_in_peaks_after_LinkageDisequilibrium_distance.txt", sep = ""),  row.names = FALSE, quote = FALSE, sep ="\t")
}